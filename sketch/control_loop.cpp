...
// A specific thing to implement: characterise a control loop by applying a dither signal to the control variable, and measuring the response. Do this for multiple frequencies, and store the data as csv files in the format `10-hz.csv`, `20-hz.csv`, etc.
